    ...
    <div class="col">
      <div class="card shadow-lg">
        <div class="card-header bg-gray-500">Data Tabel hasil Pembayaran</div>
          <div class="card-body">
            <form method="POST" action="<?=base_url('page_pelanggan/bayar_edit');?>">
            ...
            <div class="modal-footer">
              <a href="<?=base_url('page_pelanggan/pembayaran');?>" type="button" class="btn btn-danger" data-dismiss="modal"><i class="fas fa-undo"></i>&nbsp;&nbsp;Batal&nbsp;</a>
