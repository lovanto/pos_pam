  ...
  <div class="col">
    <div class="collapse multi-collapse" id="multiCollapseExample1">
      <div class="card">
        ...
        <div class="card-body">
          <form method="post" accept-charset="utf-8" enctype="multipart/form-data" action="<?= base_url('page/pelanggan_tambah'); ?>">
            ...
            <div class="card-footer">
              <b><a href="<?= base_url('page/form_i_pelanggan'); ?>">import data</a></b>
            </div>
              ...
              <tbody>
                ...
                foreach ($cstm as $s) : $no++; ?>
                  <tr>
                    ...
                    <td class="text-center text-middle"><a href="<?= base_url('page/pelanggan_ubah') ?>/<?= $s['id']; ?>" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-edit text-success"></i></a> | <a href="<?= base_url('page/pelanggan_hapus') ?>/<?= $s['id']; ?>" class="tombol_hapus" data-toggle="tooltip" data-placement="top" title="Hapus"><i class="fas fa-trash text-danger"></i></a>
                    </td>
                    <td><a href="<?= base_url('page/cetak_pelanggan') ?>/<?= $s['no_pelanggan']; ?>" target="_blank" class="btn btn-success btn-sm">cetak</a>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
