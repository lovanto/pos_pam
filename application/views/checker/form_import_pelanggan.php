 ...
 <div class="container">
                    ...
                    <form method="post" action="<?php echo base_url("page_checker/form_i_pelanggan"); ?>" enctype="multipart/form-data">
                      <!--
                    ...
                    if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form
                      ...
                      echo "<form method='post' action='".base_url("page_checker/import_pelanggan")."'>";
                      ...
                      // }else{ // Jika semua data sudah diisi
                        ...
                        echo "<a href='".base_url("page_checker/pelanggan")."'>Cancel</a>";
                      // }
