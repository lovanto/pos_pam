function terbilang($numb){  
	...
	<table><tr><td style="vertical-align: top; padding-right: 9px;">terbilang</td><td style="vertical-align: top;">:</td><td style="text-align: left;"><?php echo wordwrap(terbilang(round(($plus_ppn + $sub_total))), 50, '<br />', true) . ' rupiah' ?>