                  ...
                  <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <?php 
                      ...
                      <tr>
                        ...
                        <td class="text-center text-middle"><a href="<?=base_url('page_pelanggan/pelanggan_ubah')?>/<?=$s['id'];?>" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-edit text-success"></i></a>
                        </td>
