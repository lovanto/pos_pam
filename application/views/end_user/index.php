...
<head>
  ...
  <link href="<?= '../asset_end_user/css/bootstrap.min.css' ?>" rel="stylesheet" media="screen">
...
<body>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="pagesDropdown">
              <a class="navigation collapse navbar-collapse navbar-ex1-collapse" style="padding: 15px;" href="#about">Profil Perusahaan</a>
              <a class="navigation collapse navbar-collapse navbar-ex1-collapse" style="padding: 15px;" href="#services">Layanan kami</a>
              <a class="navigation collapse navbar-collapse navbar-ex1-collapse" style="padding: 15px;" href="#team">Team</a>
            </div>
            </a>
          </li>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="pagesDropdown">
              ...
              <a class="navigation collapse navbar-collapse navbar-ex1-collapse" style="padding: 15px;" href="<?= base_url('Auth'); ?>">Login</a>
              <a class="navigation collapse navbar-collapse navbar-ex1-collapse" style="padding: 15px;" href="#daftarin">Daftar</a>
            </div>
            </a>
          </li>
  ...
  <!-- COUNT DATA -->
  <section id="overview" style="margin-top: 50px;" class="marginMin">
    <div class="container">
      <div class="row">
      ...
      <div class="row">
        <div class="col-md-12">
          <div id="carousel-overview" class="service carousel slide">
            <!-- slides -->
                    ...
                    <div class="screenshot wow bounceInRight">
                      <div class="card">
                        ...
                        <div class="card-body">
                          <div class="row">
                            <div class="col-md-6">
                              <img src="<?= base_url('asset_end_user/img/person.png'); ?>" style="width: 120px; margin: 20px;">
                            </div>
                            <div class="col-md-4" style="font-size: 20px;">
                              <p class="card-text marginBPhone" style="font-size: 80px; padding-top: 45px;">
                                <?php echo $this->UserModel->get_data2('pelanggan')->num_rows(); ?>
                              </p>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="screenshot wow bounceInRight">
                      <div class="card">
                        ...
                        <div class="card-body">
                          <div class="row">
                            <div class="col-md-6">
                              <img src="<?= base_url('asset_end_user/img/bill.png'); ?>" style="width: 120px; margin: 20px;">
                            </div>
                            <div class="col-md-4" style="font-size: 20px;">
                              <p class="card-text marginBPhone" style="font-size: 80px; padding-top: 45px;">
              ...
              <div class="item">
                <div class="row">
                  ...
                  <div class="col-sm-12 col-md-5">
                    <div class="screenshot wow bounceInRight">
                      <div class="card">
                        <h5 class="card-header">Total Pegawai</h5>
                        <div class="card-body">
                          <div class="row">
                            <div class="col-md-6">
                              <img src="<?= base_url('asset_end_user/img/worker.png'); ?>" style="width: 120px; margin: 20px;">
                            </div>
                            <div class="col-md-4" style="font-size: 20px;">
                              <p class="card-text marginBPhone" style="font-size: 80px; padding-top: 45px;">
  ...
  <!-- About -->
  <section id="about" class="home-section bg-white" class="marginMin">
    <div class="container">
      <div class="row">
        <div class="col-md-offset-2 col-md-8">
          <div class="section-heading">
  ...
  <!-- Services -->
  <section id="services" class="home-section bg-white marginMin">
    <div class="container">
      <div class="row">
        <div class="col-md-offset-2 col-md-8">
          <div class="section-heading">
  ...
  <!-- Team -->
  <section id="team" class="home-section bg-white marginMin">
    <div class="container">
      <div class="row">
        <div class="col-md-offset-2 col-md-8">
          <div class="section-heading">
  ...
  <section id="daftarin" class="home-section bg-white marginMin">
    <div class="container">
      <div class="row">
        <div class="col-md-offset-2 col-md-8">
          <div class="section-heading">
  ...
  <!-- Contact -->
  <section id="contact" class="home-section bg-gray marginMin">
    <div class="container">
      <div class="row">
        <div class="col-md-offset-2 col-md-8">
          <div class="section-heading">
  ...
  <!-- Bottom widget -->
  <section id="bottom-widget" class="home-section bg-white marginMin">
    <div class="container">
      <div class="row">
        <div class="col-md-4">
  ...
  <script>
    ...
    function initialize() {
      var propertiPeta = {
        center: new google.maps.LatLng(-6.8892974, 107.6657453),
        zoom: 15,
