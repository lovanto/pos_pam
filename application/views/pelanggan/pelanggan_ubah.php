  ...
  <div class="row">
    <div class="col">
      <div class="card shadow-lg">
        ...
        <div class="card-body">
          <form method="POST" action="<?= base_url('page_pelanggan/pelanggan_edit'); ?>">
            ...
            <div class="container">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <input type="text" class="form-control form-control-user" id="biaya_instalasi" value="<?= $cstm['biaya_instalasi']; ?>" name="biaya_instalasi" placeholder="Masukan Biaya Instalasi" required>
                ...
                <div class="modal-footer">
                  <a href="<?= base_url('page_pelanggan/pelanggan'); ?>" type="button" class="btn btn-danger" data-dismiss="modal"><i class="fas fa-undo"></i>&nbsp;&nbsp;Batal&nbsp;</a>
