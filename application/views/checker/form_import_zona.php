 <div class="container">
                    ...
                    <form method="post" action="<?php echo base_url("page_checker/form"); ?>" enctype="multipart/form-data">
                      <!--
                    ...
                    if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form
                      ...
                      echo "<form method='post' action='".base_url("page_checker/import")."'>";
                      ...
                      <?php
                        ...
                        echo "<a href='".base_url("page_checker/zona")."'>Cancel</a>";
                      }
