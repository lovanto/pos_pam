...
INSERT INTO `pelanggan` (`id`, `no_pelanggan`, `nama`, `alamat`, `email`, `tgl_lahir`, `jk`, `no_ktp`, `no_telp`, `telp_rumah`, `zona`, `tarif`, `kategori`, `pakai_meter`, `tgl_reg`, `status`, `biaya_instalasi`, `nama_pegawai`, `user_create`, `create_date`, `user_update`, `update_date`) VALUES (1, 298773671, 'Wulan Maria Ulfah ST 1', 'Ds.Sukawening 1', 'wulammariaulfah@gmail.com 1', '1994-09-01', 'perempuan', 2147483641, '01827621831', '1292384911', 'Z11', 2000001, 'golongan c1', 301, '2020-01-01', '#', 10000, '---Pilih nama_pegawai----', '', '0000-00-00', 'dani hamdani', '2020-06-11');
...
INSERT INTO `pelanggan` (`id`, `no_pelanggan`, `nama`, `alamat`, `email`, `tgl_lahir`, `jk`, `no_ktp`, `no_telp`, `telp_rumah`, `zona`, `tarif`, `kategori`, `pakai_meter`, `tgl_reg`, `status`, `biaya_instalasi`, `nama_pegawai`, `user_create`, `create_date`, `user_update`, `update_date`) VALUES (10, 324234234, 'qawdwd', 'oajlhdnkw wa lwkn', 'aoiwdlnkaw lkn', '2019-12-31', 'perempuan', 234234, '2342423424', '234234324', '34', 8000, 'golongan d', 301, '2020-12-31', 'Aktif', 10000, 'dudu', 'dani hamdani', '2020-06-11', '', '0000-00-00');
...
INSERT INTO `user` (`id_user`, `username`, `password`, `nama_user`, `id_level`, `user_create`, `create_date`, `user_update`, `update_date`) VALUES (1, 'dani', 'dani', 'dani hamdani', 1, '', '0000-00-00', 'dani hamdani', '2020-06-11');
INSERT INTO `user` (`id_user`, `username`, `password`, `nama_user`, `id_level`, `user_create`, `create_date`, `user_update`, `update_date`) VALUES (7, 'wulan', 'wulan', 'wulan maria ulfah', 3, '', '0000-00-00', 'wulan maria ulfah', '2020-06-11');
...
INSERT INTO `user` (`id_user`, `username`, `password`, `nama_user`, `id_level`, `user_create`, `create_date`, `user_update`, `update_date`) VALUES (9, 'gila', 'lov', 'juara', 2, 'dani hamdani', '2020-01-24', 'juara', '2020-06-11');
...
INSERT INTO `user` (`id_user`, `username`, `password`, `nama_user`, `id_level`, `user_create`, `create_date`, `user_update`, `update_date`) VALUES (12, 'apa', 'apaya', 'Apa pun ini', 4, '', '0000-00-00', '', '0000-00-00');
INSERT INTO `user` (`id_user`, `username`, `password`, `nama_user`, `id_level`, `user_create`, `create_date`, `user_update`, `update_date`) VALUES (13, 'lovanto', 'lovanto', 'LOVANTOOOO', 4, 'dani hamdani', '2020-06-11', '', '0000-00-00');
...
INSERT INTO `zona` (`id`, `zona`, `wilayah`, `kategori`, `tarif`, `user_create`, `create_date`, `user_update`, `update_date`) VALUES (17, '34', 'adwad', 'golongan d', 8000, '', '0000-00-00', '', '0000-00-00');
INSERT INTO `zona` (`id`, `zona`, `wilayah`, `kategori`, `tarif`, `user_create`, `create_date`, `user_update`, `update_date`) VALUES (19, '344', 'edsfsef', 'golongan a', 6800, '', '0000-00-00', '', '0000-00-00');
