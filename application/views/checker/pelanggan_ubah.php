  ...
  <div class="row">
    <div class="col">
      <div class="card shadow-lg">
        ...
        <div class="card-body">
          <form method="POST" action="<?= base_url('page_checker/pelanggan_edit'); ?>">
            ...
            <div class="container">
              ...
              <div class="card">
                ...
                <div class="modal-footer">
                  <a href="<?= base_url('page_checker/pelanggan'); ?>" type="button" class="btn btn-danger" data-dismiss="modal"><i class="fas fa-undo"></i>&nbsp;&nbsp;Batal&nbsp;</a>
