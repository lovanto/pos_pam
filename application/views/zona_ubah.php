  ...
  <div class="row">
    <div class="col">
      <div class="card shadow-lg">
        ...
        <div class="card-body">
          <form method="POST" action="<?= base_url('page/zona_edit'); ?>">
            <div class="modal-body">
              <div class="form-group">
                ...
                <select name="kategori" class="form-control form-control-user" required>
                  ...
                  <option value="golongan a" <?php
                                              if ($zona['kategori'] == "golongan a") {
                                                echo "selected";
                                              }
                                              ?>>Air Minum /Rumah tangga</option>
                  <option value="golongan b" <?php
                                              if ($zona['kategori'] == "golongan b") {
                                                echo "selected";
                                              }
                                              ?>>Bahan Baku air minum/ keperluan RT</option>
                  <option value="golongan c" <?php
                                              if ($zona['kategori'] == "golongan c") {
                                                echo "selected";
                                              }
                                              ?>>Peternakan</option>
                  <option value="golongan d" <?php
                                              if ($zona['kategori'] == "golongan d") {
                                                echo "selected";
                                              }
                                              ?>>Perusahaan</option>
                </select>
            ...
            <div class="modal-footer">
              <a href="<?= base_url('page/zona'); ?>" type="button" class="btn btn-danger" data-dismiss="modal"><i class="fas fa-undo"></i>&nbsp;&nbsp;Batal&nbsp;</a>
